    ...
    <div className="form-card" style={{ marginTop: '30px' }}>
      ...
      <form className="main-form" onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input type="text" className="form-input" placeholder="Ej: Preparar informe trimestral" value={titulo} onChange={(e) => setTitulo(e.target.value)} required />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="date" className="form-input" min={hoy} value={fechaLimite} onChange={(e) => setFechaLimite(e.target.value)} required />
        </div>

        <div className="form-group">
          <label className="form-label">Descripción (Opcional)</label>
          <textarea className="form-input" placeholder="Añade más detalles sobre la tarea..." value={descripcion} onChange={(e) => setDescripcion(e.target.value)} maxLength="500" rows="4" />
          <div className="char-counter">{descripcion.length} / 500</div>
        </div>

        <div className="form-actions">
          <Link to="/" className="btn-icon" style={{ textDecoration: 'none' }}>Cancelar</Link>
